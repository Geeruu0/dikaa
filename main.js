...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6285707042602@s.whatsapp.net`, {text: 'BERHASIL TERSAMBUNG KE BOT ✿GEERUU✿ JANGAN LUPA SAVE GEERU, PASTI DI SAVEBACK' })
}
...
global.reloadHandler = function (restatConn) {
  ...
  conn.bye = 'Sipp! Beban Berkurang satu @user'
